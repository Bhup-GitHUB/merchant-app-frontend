    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20 mx-auto text-center">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight">
          Powerful Merchant
          <br />
          <span className="text-gradient font-medium">Payment Solutions</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400">
          Everything merchants need to accept payments, manage business, and grow revenue with industry-leading rates.
        </p>
      </div>
